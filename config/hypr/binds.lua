...
hl.bind(mainMod .. " + Y",          hl.dsp.exec_cmd(launchPrefix .. "kitty -e yazi"))
hl.bind(mainMod .. " + L",          hl.dsp.exec_cmd(launchPrefix .. OFFICE))
hl.bind(mainMod .. " + A", 	    hl.dsp.exec_cmd("antigravity-ide"))
-- hl.bind(mainMod .. " + Y", 	    hl.dsp.exec_cmd("yazi"))
...
hl.bind(mainMod .. " + P",    hl.dsp.exec_cmd(noctCall .. "panel-toggle session"))
